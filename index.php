...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics/apple-touch-icon1.png">
    <link rel="icon" type="image/png" sizes="32x32" href="statics/favicon-33x33.png">
    <link rel="icon" type="image/png" sizes="16x16" href="statics/favicon-17x17.png">
    ...
    <div id="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top" style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px black;">
            <div class="container-fluid">
                <a href="index.php"><img src="statics\logo1.png" alt="" style="height: 80px; margin-left:25px; margin-top:10px;"></a>
        ...
        <div class="container-large" style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:blue;">
            <div class="row">
                <div class="col" style="margin-left: 5%;">
                    <br><br>&nbsp;<p class="zoomfont" style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;">
                        <b>Welcome to <br> Money Bank!</b>
                    </p>
                </div>
                <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                    &nbsp;<img src="statics/money.jpg" class="zoomin" alt="" style="width:0px;">
                </div>
            </div>
        </div>
        <img src="statics/.png" alt="" style="width:100%; position:absolute; z-index:-1">
        ...
        <center style="margin:60px 0px 20px 0px;">
            <div class="container" style="backdrop-filter: blur(10px); box-shadow:3px 3px 15px black; border-radius:30px; padding:20px 0px 20px 0px;">
                <h1 style="text-indent:2px 2px 2px gray; color:white;"><b>Our Bank Facilities</b></h1>
                <div class="container" style="margin:30px 0px 20px 0px;">
                    <div class="row">
                        <div class="col-lg">
                            <div style="color:white; background-color: black; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
