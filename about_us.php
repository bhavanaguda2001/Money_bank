...
<head>
    ...
    <title>About us - Money Bank</title>
...
<body style="background-color:blue;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\logo1.png" alt=""
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:60%; background-color:rgba(0,0,0,.5); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px antiquewhite;">
                <h1 style=" color:white;">About Intern</h1>
            </div>
            <br><br>
            <img src="statics/bhavana.jpg" alt="" style="width:16%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Bhavana Guda</h1>
            <p style="color:beige;"><b>Intern at Sparks Foundation <br> Shree Siddheshwar Women's College of Engineering, Solapur</b></p>
    </center>
