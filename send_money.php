...
<head>
    ...
    <title>Send money - Money Bank</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head>

<body style="background-color:blue; padding-top:8%;">
        ...
        <div class="container" style="margin-top:2%;">
            ...
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="send_money.php" method="post">
                    ...
                    <p style="color:white;">Want to check your balance? check <a href="check_blc.php" style="color: black;">here</a></p>
                </form>
            </div>
        </div>
